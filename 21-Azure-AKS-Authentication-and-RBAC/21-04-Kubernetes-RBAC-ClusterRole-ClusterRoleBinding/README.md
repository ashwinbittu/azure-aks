...
AKS_READONLY_USER_OBJECT_ID=$(az ad user create \
  ...
  --user-principal-name aksread1@ashwinbittugmail.onmicrosoft.com \
  --password @AKSDemo123 \
...
- Username: aksread1@ashwinbittugmail.onmicrosoft.com
- Password: @AKSDemo123
...
# Error Message
kubectl create namespace dev
Error from server (Forbidden): namespaces is forbidden: User "aksread1@ashwinbittugmail.onmicrosoft.com" cannot create resource "namespaces" in API group "" at the cluster scope
...
# Users
  - user1aksadmin@ashwinbittugmail.onmicrosoft.com 
  - aksdev1@ashwinbittugmail.onmicrosoft.com
  - aksread1@ashwinbittugmail.onmicrosoft.com
# Groups
  - k8sadmins
  - devaksteam
  - aksreadonly
