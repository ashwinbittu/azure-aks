...
DEV_AKS_USER_OBJECT_ID=$(az ad user create \
  ...
  --user-principal-name aksdev1@ashwinbittugmail.onmicrosoft.com \
  --password @AKSDemo123 \
...
- Username: aksdev1@ashwinbittugmail.onmicrosoft.com
- Password: @AKSDemo123
...
Error from server (Forbidden): services is forbidden: User "aksdev1@ashwinbittugmail.onmicrosoft.com" cannot list resource "services" in API group "" in the namespace "qa"
```
