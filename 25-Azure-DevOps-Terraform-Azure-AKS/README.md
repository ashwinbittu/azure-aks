...
git remote add origin https://github.com/ashwinbittu/azure-devops-aks-kubernetes-terraform-pipeline.git
git push --set-upstream origin master 

# Verify the same on Github Repository
Refersh browser for Repo you have created
Example: https://github.com/ashwinbittu/azure-devops-aks-kubernetes-terraform-pipeline.git
```     
...
### Where is your Code?
- Github
- Select a Repository: ashwinbittu/azure-devops-aks-kubernetes-terraform-pipeline
